...
public class SelfProfileBtn extends AbstractItem {
    private final ContainerGUI container;
    private final Player player;


    public SelfProfileBtn(@NotNull final ContainerGUI container, @NotNull final Player player) {
    ...
    public ItemProvider getItemProvider() {
        ...
        String nameText = "Ваш профиль";
        Component name = MiniMessage.miniMessage().deserialize("<i:false><white>"+nameText+"</white></i>");
        m.displayName(name);

        String loreKey = "ui.element.playerlist.button.selfprofile.lore";
